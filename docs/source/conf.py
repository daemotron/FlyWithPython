...
# -*- coding: utf-8 -*-
#
# FlyWithPython documentation build configuration file, created by
# sphinx-quickstart on Sat Jan 27 11:02:04 2018.
#
...
project = 'FlyWithPython'
copyright = '2017, 2018 The Stormrose Project'
author = 'The Stormrose Project'
...
htmlhelp_basename = 'FlyWithPythondoc'
...
latex_documents = [
    (master_doc, 'FlyWithPython.tex', 'FlyWithPython Documentation',
     'The Stormrose Project Team', 'manual'),
]
...
man_pages = [
    (master_doc, 'flywithpython', 'FlyWithPython Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'FlyWithPython', 'FlyWithPython Documentation',
     author, 'FlyWithPython', 'One line description of project.',
     'Miscellaneous'),
]
